...
modelo([
    ...
    (
    (Animal_1 == cavalos, Cigarro_2 == dunhill);
    (Animal_2 == cavalos, (Cigarro_1 == dunhill; Cigarro_3 == dunhill));
    (Animal_3 == cavalos, (Cigarro_2 == dunhill; Cigarro_4 == dunhill));
    (Animal_4 == cavalos, (Cigarro_3 == dunhill; Cigarro_5 == dunhill));
    (Animal_5 == cavalos, Cigarro_4 == dunhill)
    ),
